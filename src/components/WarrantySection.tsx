            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-8 mb-6">
                    ...
                    <div className="flex-1 flex justify-center order-first lg:order-last">
                        <div className="w-48 h-48 md:w-64 md:h-64 bg-slate-200 dark:bg-slate-800 rounded-full flex items-center justify-center">
                            <ShieldCheck className="w-24 h-24 md:w-32 md:h-32 text-slate-300 dark:text-slate-600" />
                        </div>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-6">
                    {[
                        ...
                        <div key={i} className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-2xl shadow-sm border border-border dark:border-slate-800 transition-all">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 md:p-8 shadow-sm border border-border dark:border-slate-700 flex flex-col lg:flex-row items-center gap-8 mb-12">
                    ...
                    <div className="flex-1 w-full h-48 md:h-64 bg-slate-100 dark:bg-slate-700/50 rounded-xl overflow-hidden relative">
                        {/* Placeholder for Roof Image */}
                        <div className="absolute inset-0 flex items-center justify-center text-slate-400 dark:text-slate-500 font-bold text-sm">
